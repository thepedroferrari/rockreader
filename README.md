...
- Upload: PDF, EPUB, TXT, Markdown, XPS, MOBI, FB2. Text is cleaned (hyphen joins, page numbers, citation brackets, URLs, emails removed) and split into paragraphs of at most ~700 characters.
...
`scripts/speak.sh "text" [voice]` does the same. `examples/stream_client.py` shows the client side in plain Python.
